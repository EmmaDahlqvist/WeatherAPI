...
async function tryFetchLocation(url){
    ...
    if(data[0]?.name !== undefined) { //Det är en korrekt stad med namn
      return true;
    } else {
      return false;
    }
  ...
  function LocationSet({setNewLocationAPI, location}){
      ...
      let newLocationLink = "http://api.openweathermap.org/geo/1.0/direct?q=" + city + "&limit=5&appid=950447352805e69f64cfaee15f180f30&units=metric";
